...
@section('title', 'Панель замера')

@section('content')
    <div class="grid gap-3">
        <div class="flex flex-wrap items-start justify-between gap-3">
            <div>
                <p class="text-xs uppercase tracking-[0.4em] text-slate-500 dark:text-slate-500">Панель замера</p>
        ...
        <form class="grid gap-3" method="POST" action="{{ route('surveyor.cashier.store') }}" data-prevent-double>
            @csrf
