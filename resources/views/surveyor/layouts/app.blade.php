...
<head>
    ...
    <title>@yield('title', 'Замерщик')</title>
                        ...
                        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:w-full">
                            <div class="flex items-center justify-between gap-3 lg:w-full">
                                ...
                                <div class="flex items-center gap-2 sm:gap-3 lg:ml-auto">
                                    <a href="{{ route('surveyor.cashier') }}"
                                        class="rounded-xl px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-900/5 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-white/5 dark:hover:text-white {{ request()->routeIs('surveyor.cashier') ? 'bg-slate-900/5 text-slate-900 dark:bg-white/5 dark:text-white' : '' }}">
                                        Панель замера
                                    </a>
                                    <a href="{{ route('surveyor.orders.index') }}"
                                        class="rounded-xl px-3 py-2 text-sm font-medium text-slate-600 transition hover:bg-slate-900/5 hover:text-slate-900 dark:text-slate-300 dark:hover:bg-white/5 dark:hover:text-white {{ request()->routeIs('surveyor.orders.*') ? 'bg-slate-900/5 text-slate-900 dark:bg-white/5 dark:text-white' : '' }}">
                                        Мои заказы
                                    </a>
